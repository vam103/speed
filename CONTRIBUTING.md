...
This outlines how to propose a change to `speed`.
...
help you write a unit test, if needed). See the guide on [how to create
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("biometryhub/speed", fork = TRUE)`.

- Install all developme nt dependencies with
...
of Conduct](https://biometryhub.github.io/speed/CODE_OF_CONDUCT.md). By
